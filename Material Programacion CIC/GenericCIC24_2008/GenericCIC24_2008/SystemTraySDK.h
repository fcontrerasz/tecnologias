...
public:
	...
	BOOL  SetChecked(UINT uiCmd, BOOL stCmd = FALSE, BOOL stCheck = FALSE);
	...
	void SetCheckedItems(UINT *mItems, BOOL *sItems, int size);
...
protected:
	...
	int CheckedItemsSize;
	UINT *CheckedItems;
	BOOL *CheckedItemsState;
// Static data
protected:
