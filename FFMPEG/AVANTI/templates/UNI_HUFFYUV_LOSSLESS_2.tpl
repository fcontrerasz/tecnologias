...
tpl_ver=0.4.9
tpl_id=UNI
tpl_desc=HUFFYUV (FFmpeg variant)
tpl_com=Huffyuv lossless format is mainly of interest as intermediar for source formatsthat are not supported by NLE programs. It uses a large amount of diskspaceand is intended to convert to a final more compressed format after editing.Frame size, frame rate and aspect ratio are set to "Source" and may needadaption, depending on the source and desired destination.* This FFmpeg huffyuv variant is expected to give the same quality at a lower  bitrate, resulting in a smaller file size.
tpl_v_cdbe=avi,---,---,DEVSD ,ffvhuff,huffyuv - FF,Y,Huffyuv FFmpeg variant
