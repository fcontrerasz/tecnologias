...
tpl_com=h264 in mp4 container / general example using FFmpeg defaults.You can change 'Bitrate' and "Frame size' as desired.You can call up the command line by expanding the report windowand pressing 'Get user video opts'.You then can add or remove commands and restore the command lineby pressing 'Set user video opts'.
tpl_v_cdbe=avi,---,mp4, EV   ,libx264,x264 (lib),Y,libx264 H.264 / AVC / MPEG-4 AVC / MPEG-4 part 10
tpl_a_cdbe=aac,---,---,DEA   ,libfaac,aac (lib),Y,libfaac AAC (Advanced Audio Codec)
avs_mode=AUTO
src2avs1=0
src2avs2=0
a_check=
